...
public class BalanceBean {
    ...
    private double R_TotalServiceAmt;
    private boolean R_PrintFromPda;

    public double getR_TotalServiceAmt() {
        return R_TotalServiceAmt;
    }

    public void setR_TotalServiceAmt(double R_TotalServiceAmt) {
        this.R_TotalServiceAmt = R_TotalServiceAmt;
    }
    ...
    public String getR_Table() {
        return R_Table.toUpperCase();
    }

    public void setR_Table(String R_Table) {
        this.R_Table = R_Table.toUpperCase();
    }
    ...
    public boolean getR_PrintFromPda() {
        return R_PrintFromPda;
    }

    public void setR_PrintFromPda(boolean R_PrintFromPda) {
        this.R_PrintFromPda = R_PrintFromPda;
    }
}
