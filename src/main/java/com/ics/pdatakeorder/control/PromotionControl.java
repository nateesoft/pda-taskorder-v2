...
import com.ics.pdatakeorder.model.TPromotion4;
import com.ics.pdatakeorder.model.TPromotion5;
import com.ics.pdatakeorder.model.TPromotion2;
import com.ics.pdatakeorder.model.ProtabBean;
...
import com.ics.pdatakeorder.model.TempPromotion;
import com.ics.pdatakeorder.model.Promotion;
import com.ics.pdatakeorder.model.TPromotion3;
...
//    public MySQLConnect c = new MySQLConnect();
                    ...
                    try {
                        ...
                        if (protab1.getPType().equals(Promotion.PROMOTION_TYPE_1)) {
                            ...
                            String sqlCheck = "select sum(R_Quan) R_Quan "
                                    ...
                                    + "and R_Void <> 'V' ";
                            ResultSet rs = mysql.getConnection().createStatement().executeQuery(sqlCheck);
                            int Total_Qty = 0;
                            ...
                            if (Item_Free <= 0) {  //ปัด 0.01 ให้เป็น 1
                                Item_Free = 1;
                            }
                            ...
                            if (Total_Qty >= Total_Rate) {
                                ...
                                sqlCheck = "select * from balance "
                                        ...
                                        + "and R_Void <> 'V' "
                                        + "order by R_Index";
                                rs = mysql.getConnection().createStatement().executeQuery(sqlCheck);
                                ...
                                while (rs.next()) {
                                    ...
                                    sqlUpdatePro = "update balance set "
                                            ...
                                            + "and R_PrType='-P' "
                                            + "and R_Void <> 'V' ";
                                    mysql.getConnection().createStatement().executeUpdate(sqlUpdatePro);
                                }
                        ...
                        //Sale Promotion Type 4
                            ...
                            if (Total_Qty >= Total_Rate) {
                                ...
                                sql = "select * from balance "
                                        ...
                                        + "and R_PrCode='" + protab1.getProCode() + "' "
                                        + "and R_Void <> 'V' ";
                                ResultSet rss = mysql.getConnection().createStatement().executeQuery(sql);
        ...
        if (TAmount > 0) {
            try {
                ...
                String updateTableFile = "update tablefile set "
                        ...
                        + "NetTotal = '" + NetTotal + "' "
                        + "where TCode='" + table + "'";
                int update = mysql.getConnection().createStatement().executeUpdate(updateTableFile);
    ...
    public void saveTempPromotion(TempPromotion bean) {
        String prType = "" + bean.getPrType();
        if (prType.equals("null")) {
            bean.setPrType("");
        }
        MySQLConnect mysql =new MySQLConnect();
        try {
